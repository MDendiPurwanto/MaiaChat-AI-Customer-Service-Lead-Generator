...
class Maia_Chat_Frontend {
                ...
                <div class="maia-chat-header">
                    <div class="maia-chat-info">
                        ...
                        <div class="maia-chat-titles">
                            ...
                            <span><?php _e('Online', 'maia-chat'); ?></span>
                        </div>
                    </div>
                ...
                <div id="maia-chat-messages" class="maia-chat-messages">
                    ...
                    <div id="maia-chat-lead-form" class="maia-chat-lead-form">
                        <div class="maia-chat-lead-form-header">
                            ...
                            <p><?php _e('Halo! Senang melihat Anda.', 'maia-chat'); ?></p>
                            <span class="form-desc"><?php _e('Silakan isi data berikut untuk mulai mengobrol.', 'maia-chat'); ?></span>
                        </div>
                        <div class="maia-field-group">
                            <label for="maia-lead-name"><?php _e('Nama Lengkap', 'maia-chat'); ?></label>
                            <input type="text" id="maia-lead-name" placeholder="<?php esc_attr_e('Contoh: Budi Santoso', 'maia-chat'); ?>" required>
                        </div>
                        <div class="maia-field-group">
                            <label for="maia-lead-phone"><?php _e('Nomor WhatsApp', 'maia-chat'); ?></label>
                            <input type="text" id="maia-lead-phone" placeholder="<?php esc_attr_e('Contoh: 08123456789', 'maia-chat'); ?>" required>
                        </div>
                        <button id="maia-lead-submit"><?php _e('Mulai Percakapan', 'maia-chat'); ?></button>
                    </div>
                    <?php endif; ?>
                </div>
    ...
    public function handle_chat_request() {
        ...
        $user_name    = isset($_POST['user_name']) ? sanitize_text_field($_POST['user_name']) : __('Guest', 'maia-chat');
