# PRD: MaiaChat Plugin (MaiaRouter Integration)

## 1. Project Overview
The **MaiaChat Plugin** is a specialized tool designed to provide a premium AI-driven customer service interface for WordPress websites. It leverages **MaiaRouter** LLMs (specifically `maia/gemini-2.5-flash`) to handle inquiries, utilizing a multi-source Knowledge Base including manual context, website URLs, and document uploads.
...
- Provide a Lead Logging dashboard for easy follow-up by site owners.
...
- **Lead Management**:
    - **Lead Logs Submenu**: Table view of all captured leads with WhatsApp follow-up links.
...
- **Lead Capture Form**:
    ...
    - Captured data is logged to server-side logs and included in chat tracking.

### 3.3. Tracking & Human Agency
- **Lead Logging**: Automatic server-side storage of captured customer data.
...
| Lead Logs Dashboard | ✅ Completed |
| Prefix & Naming Audit | ✅ Completed |
...
- **Modernity**: Avoid legacy styles; use shadows, rounded corners, and smooth transitions.
